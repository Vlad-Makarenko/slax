defmodule SlaxWeb.ChatRoomLive.Index do
  ...
  def render(assigns) do
    ...
    <main class="flex-1 p-6 max-w-4xl mx-auto">
      ...
      <div class="bg-slate-5 border rounded">
        <div id="rooms" class="divide-y" phx-update="stream">
          <div
            ...
            id={id}
            phx-click={JS.navigate(~p"/rooms/#{room.id}")}
          >
            <div>
    ...
    <.modal id="new-room-modal">
      <.header class="">New chat room</.header>
      <.live_component
  ...
  def handle_event("toggle-room-membership", %{"id" => id}, socket) do
    {room, joined?} =
      id |> Chat.get_room!() |> Chat.toggle_room_membership(socket.assigns.current_user)
